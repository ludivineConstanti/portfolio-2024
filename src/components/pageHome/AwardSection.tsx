...
const AwardSection = ({
  ...
  return (
    <Section
      ...
      link={{ href: "", text: "See all Awards" }}
    >
      <div className="flex w-full justify-center">
        <ul className="grid max-w-home flex-wrap items-center justify-start gap-2 gap-y-10 sm:flex sm:justify-center sm:gap-x-20 xl:max-w-home-xl">
